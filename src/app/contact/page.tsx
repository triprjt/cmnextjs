        ...
        <div className="min-h-screen bg-white flex flex-col">
            ...
            <div className="max-w-3xl mx-auto px-4 py-8">
                ...
                <section className="bg-gray-50 p-6 rounded-lg">
                    <h2 className="text-2xl font-bold text-gray-800 mb-6">संदेश भेजें</h2>
                ...
                <section className="mt-12">
                    ...
                    <div className="flex gap-4">
                        ...
                        <a href="https://www.instagram.com/charchagram.collective/" target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-50 rounded-full hover:bg-gray-100 transition-colors">
                            <svg className="w-6 h-6 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
