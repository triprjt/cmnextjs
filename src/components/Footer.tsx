        ...
        <footer className="bg-[#273F4F] text-white py-8 mt-auto">
            <div className="max-w-3xl mx-auto px-4">
                <div className="grid md:grid-cols-3 gap-8 mb-8">
                    ...
                    {/* Connect With Us */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4">हमसे जुड़ें</h3>
                ...
                <div className="pt-8 border-t border-gray-600 text-sm">
                    <p className="text-center mb-2">© 2025 चर्चाग्राम - सभी अधिकार सुरक्षित</p>
                    <p className="text-center text-gray-400">चर्चा फाउंडेशन द्वारा संचालित</p>
                </div>
            </div>
        </footer>
    );
